<template>
  <div>
    ...
    <knowledge-base></knowledge-base>
     <!-- :topics="topics" we feed the topics array from the :topics props from knowledge base-->
  </div>
</template>
...
export default {
  ...
  provide(){
    return{
      //key from topics does need to be the same as data, it could be yes or not
      topics:this.topics,

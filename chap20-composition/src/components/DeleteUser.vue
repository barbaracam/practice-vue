...
export default {
  ...
  setup() {
    const alertTitle = ref('Delete User again?');
   //this array comes from alert.js the return, it has toi be same order
   //hooks can take function
   const [alertIsVisible,
      showAlert,
      hideAlert] = useAlert(true);

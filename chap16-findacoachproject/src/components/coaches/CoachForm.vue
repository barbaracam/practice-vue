<template>
    <form @submit.prevent="submitForm">   
        ...
        <div class="form-control" :class="{invalid: !areas.isValid}">
            ...
            <p v-if="!areas.isValid">Checkmark at least one</p>          
        </div>
        <p v-if="!formIsValid">Fix empty boxes</p>
    ...
    methods:{
      ...
      validateForm(){
        ...
        submitForm(){
          ...
          if(!this.formIsValid){
            //form is not valid wont continue
            return;
          }
            const formData = {

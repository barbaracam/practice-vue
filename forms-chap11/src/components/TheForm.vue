<template>
  <form @submit.prevent="submitForm()">
    ...
    <!-- v-model is a shortcut for @input="" :value="" -->
    <!-- after adding the emit is the same in this form as :model-value="" @update="modelValue=""  -->
    <div class="form-control">
      <rating-control v-model="rating" ></rating-control>
    </div>
    <div class="form-control">
      <input id="confirm-terms" name="confirm-terms" type="checkbox" v-model="confirm" />
      <label for="confirm-terms">Agree of terms of use?</label>
    </div>
    <div>
...
components:{
  ...
  methods:{
    submitForm(){
      ...
      // it is a number type as I added type=number in the input
      console.log(this.userAge + 5);
      //it is a string the ageInput as we use ref
      ...
      this.interest=[];
      this.how=null;
      //many checkboxes in an array, one checkbox true or false
      console.log('Confirm? ');
